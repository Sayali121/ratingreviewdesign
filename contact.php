<?php include "header.php" ?>
        ...
        <div class="row">
                                ...
                                <div class="">We highly value your feedback! Kindly take a moment to rate your experience and provide us with your valuable feedback.</div>
                                ...
                                <div class="form-wrapper">
                                    <form id="" action="ratingandreview.php" method="POST">
                   <br>
                  <div class="row">
                  <div class='starrr' id='rating-student' name="ratings"></div> 
                  ...
                  <div class="form-group single-form" style="margin-top:10px">
                   
                    <textarea class="form-control" id="reviews" name="reviews" type="text" placeholder="Tell Us about your experience!" required="true"></textarea>
                  </div>
                  ...
                  <div class="single-form">
                                            <button type="submit" class="btn btn-primary btn-hover-dark w-100">Send <i class="flaticon-right"></i></button>
                                        </div>
...
<form>
       ...
       <!--Rating and review section End-->
        <!-- Contact Map Start -->
        <div class="section pb-10" style="margin-top:10px">
            <div class="container">
    ...
    <script src="assets/js/main.js"></script>
        ...
        <script>
            function validateForm() {
              ...
              if (selectedValue === "") {
                alert("Field is required. Please select an option.");
  ...
  var selectedCode = dropdown.options[dropdown.selectedIndex].value;
  
  var phoneNumberInput = document.getElementById("phoneNumberInput");
  var phoneNumber = phoneNumberInput.value;
  
  var fullPhoneNumber = phoneNumber + " " + selectedCode;
  
  // Display the full phone number
  var resultElement = document.getElementById("result");
  resultElement.innerHTML = "Full Phone Number: " + fullPhoneNumber;
}
    </script>
